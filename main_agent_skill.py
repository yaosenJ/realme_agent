...
from core.memory_manager import cleanup_inactive_threads_task, get_or_create_thread_memory, clear_thread_memory
from utils.stream_utils import openai_stream_generator
...
async def lifespan(app: FastAPI):
    ...
    asyncio.create_task(cleanup_inactive_threads_task())
    yield
    print("[停止] 服务关闭")
...
async def clear_history(thread: str = "default_thread"):
    ...
    await clear_thread_memory(thread)
